        ...
        >
            ...
            >
                ...
                <HStack spacing={10} mr={{ base: 0, sm: 8 }} as='nav' style={{ fontFamily: 'Poppins' }}>
                    ...
                    <Text as='a' href='#footer' fontSize='lg'>Contact</Text>
                    {/* <Text as='a' href='#' fontSize='lg'>About</Text> */}
                    {/* <Button href={'#builder'} colorScheme={'purple'} fontWeight={'medium'} >Templates</Button> */}
                    <Button as="a" href="#builder" colorScheme="purple" fontWeight="medium">Templates</Button>
                </HStack>
            </Flex>
